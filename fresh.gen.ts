...
import * as $api_colorize from "./routes/api/colorize.ts";
import * as $api_figlet from "./routes/api/figlet.ts";
...
const manifest = {
  routes: {
    ...
    "./routes/api/colorize.ts": $api_colorize,
    "./routes/api/figlet.ts": $api_figlet,
