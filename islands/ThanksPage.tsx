// deno-lint-ignore-file react-no-danger -- celebrationArt is generated by ASCIIFIER as color span markup.
  ...
  useEffect(() => {
    ...
    const generateCelebration = async () => {
      try {
        ...
        const data = await response.json() as CelebrationResponse;
